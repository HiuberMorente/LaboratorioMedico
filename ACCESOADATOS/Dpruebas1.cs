   ...
   public class Dpruebas1
    {
        ...
        public Dpruebas1(int id, int idtipo,string nombre, string descripcion, decimal precio, DateTime fechasolicitud, DateTime fecharealizo, DateTime fechavigencia, string observaciones, int idcliente, int iduser,string comprobante)
        {
            this.Id = id;
            this.Idtipo = idtipo;
            this.Nombre = nombre;
        ...
        public string Insertar(Dpruebas1 Pruebas, List<Ddetalle_pruebas> Detalles)
        {
            ...
            try
            {
                ...
                SqlParameter ParComprobante3 = new SqlParameter();
                ParComprobante3.ParameterName = "@comprobante";
                ParComprobante3.SqlDbType = SqlDbType.VarChar;
                ParComprobante3.Size = 35;
                ParComprobante3.Value = Pruebas.Comprobante;
                SqlCmd.Parameters.Add(ParComprobante3);
                ...
                if (rpta.Equals("OK"))
                {
                    ...
                    foreach (Ddetalle_pruebas det in Detalles)
                    {
                        ...
                        else
                        {
                                ...
                                //rpta = DisminuirStock(det.Idinsumo, det.Cantidad,det.Iddcompra);
                                //if (!rpta.Equals("OK"))
                                //{
                                //    break;
                                //}

                            rpta = DisminuirStockcompra(det.Idinsumo, det.Cantidad);
                            if (!rpta.Equals("OK"))
                            {
                                break;
                            }
        ...
        //public string DisminuirStock(int idinsumo, int cantidad, int idcompra)
        //{
        //    string rpta = "";
        //    SqlConnection SqlCon = new SqlConnection();
        //    try
        ...
        //        ParIddetalle_ingreso.Value = idinsumo;
        ...
        //        SqlParameter ParCantidad1 = new SqlParameter();
        //        ParCantidad1.ParameterName = "@idcompra";
        //        ParCantidad1.SqlDbType = SqlDbType.Int;
        //        ParCantidad1.Value = idcompra;
        //        SqlCmd.Parameters.Add(ParCantidad1);
        ...
        public string DisminuirStockcompra(int idinsumo, int cantidad)
        {
            string rpta = "";
            SqlConnection SqlCon = new SqlConnection();
            try
            {
                ...
                SqlCommand SqlCmd = new SqlCommand();
                SqlCmd.Connection = SqlCon;
                SqlCmd.CommandText = "disminuir_stock_COMPRA";
                SqlCmd.CommandType = CommandType.StoredProcedure;
