...
namespace PRESENTACION.clientes
{
    public partial class FormStock : Form
    {
        ...
        public void Mostrar()
        {
            this.dataproveedor.DataSource = Nreportes.Mostrar();
            this.OcultarColumnas();
      
        }

        private void BuscarinsumoNombre()
        {
            this.dataproveedor.DataSource = Nreportes.BuscarinsumoNombre(this.textBox1.Text);
            this.OcultarColumnas();

        }

        private void BuscarinsumoCodigo()
        {
            this.dataproveedor.DataSource = Nreportes.BuscarinsumoCodigo(this.textBox1.Text);
            this.OcultarColumnas();
        ...
        private void textBox1_TextChanged(object sender, EventArgs e)
        {
            ...
            {
                if (cbbuscar.Text == "INSUMO")
                {
                    if (this.textBox1.Text != string.Empty)
                    {
                        this.BuscarinsumoNombre();
                    }
