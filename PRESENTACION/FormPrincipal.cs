...
namespace PRESENTACION
{
...

    {
        ...
        {
            Cargadatosuser();
            if (Cachesesionuser.roles_id == Cargosuser.Empleado)
            {
        ...
        private void btnproductos1_Click(object sender, EventArgs e)
        {
            ...
            ////abrirformhijo(Formcliente.GetInstancia()) ;
            Formcliente formcli = Formcliente.GetInstancia();
            formcli.TopLevel = false;
            formcli.FormBorderStyle = FormBorderStyle.None;
            formcli.Dock = DockStyle.Fill;
            panelformularios.Controls.Add(formcli);
            panelformularios.Tag = formcli;
        ...
        {
            //abrirformhijo(Forminsumos.GetInstancia());
            Forminsumos formcli = Forminsumos.GetInstancia();
            formcli.TopLevel = false;
            formcli.FormBorderStyle = FormBorderStyle.None;
            formcli.Dock = DockStyle.Fill;
            panelformularios.Controls.Add(formcli);
        ...
        {
            ////abrirformhijo(Formcompra.GetInstancia());
            Formcompra formcli = Formcompra.GetInstancia();
            formcli.TopLevel = false;
            formcli.FormBorderStyle = FormBorderStyle.None;
            formcli.Dock = DockStyle.Fill;
            panelformularios.Controls.Add(formcli);
        ...
        {
            //abrirformhijo(Formtipo.GetInstancia());
            Formtipo fordl = Formtipo.GetInstancia();
        ...
        {
            //abrirformhijo(Formpruebas.GetInstancia());
            Formpruebas formcli = Formpruebas.GetInstancia();
            formcli.TopLevel = false;
            formcli.FormBorderStyle = FormBorderStyle.None;
            formcli.Dock = DockStyle.Fill;
            panelformularios.Controls.Add(formcli);
        ...
        {
            ////abrirformhijo(FormUsuario.GetInstancia());
            FormUsuario formcli = FormUsuario.GetInstancia();
            formcli.TopLevel = false;
            formcli.FormBorderStyle = FormBorderStyle.None;
            formcli.Dock = DockStyle.Fill;
            panelformularios.Controls.Add(formcli);
        ...
        {
            //abrirformhijo(Formproveedor.GetInstancia());
            Formproveedor formcli = Formproveedor.GetInstancia();
            formcli.TopLevel = false;
            formcli.FormBorderStyle = FormBorderStyle.None;
            formcli.Dock = DockStyle.Fill;
            panelformularios.Controls.Add(formcli);
        ...
        {
            Mostrarsub(plreportes);
        }

        private void button8_Click_1(object sender, EventArgs e)
        {
            abrirformhijo(new FormMovimientos());
        }
