...
namespace NEGOCIO
{
    public class Npruebas
    {
        ...
        //de la CapaDatos
        public static string Insertar(int idtipo, string nombre, string descripcion, decimal precio, DateTime fechasolicitud, DateTime fecharealizo, DateTime fechavigencia, string observaciones, int idcliente, int iduser, DataTable dtDetalles)
        {
        ...
        public static string Editar(int id, int idtipo, string nombre, string descripcion, decimal precio, DateTime fechasolicitud, DateTime fecharealizo, DateTime fechavigencia, string observaciones, int idcliente, int iduser)
        {
            Dpruebas1 Obj = new Dpruebas1();
            Obj.Id = id;
            Obj.Idtipo = idtipo;
